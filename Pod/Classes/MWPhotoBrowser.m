...
- (void)viewDidLoad {
    ...
    if (self.displayNavArrows) {
        ...
        _nextButton = [[UIBarButtonItem alloc] initWithImage:nextButtonImage style:UIBarButttitleForPhotoAtIndexonItemStylePlain target:self action:@selector(gotoNextPage)];
    }
